...
The macOS build output contains the pinned Electron runtime, desktop host and eïlo wordmark icon. Runtime state, local models, conversation data and credentials are not copied into the app bundle. Do not distribute this development bundle as a self-contained release.
