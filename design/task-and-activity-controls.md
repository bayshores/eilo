...
The earlier navigation checkpoint's lack of task forms is superseded by this explicitly requested optional editor. The broader navigation composition and automatic-upkeep direction remain current. See [navigation](navigation-workspaces.md) and [current project decisions](../PROJECT.md).
